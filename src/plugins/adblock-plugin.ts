...
export const AdBlockerPlugin = (): Plugin => {
	...
	const classesToRemove: string[] = [
		...
		'message-box',
		'number-count',
		'pAa1CCxkvvHGQXbBsNFj',
		'FgLD2AWEBHoBZhoItE6Q',
		'PM7rjKYzufGxbLumLbeV',
		'ITNBVjxxuF9MRBjgYsnh',
		'S4yb1bzpXCmFehhh77Dl',
		'Y77JbFMnxjW1NqbJ8h74',
		'D1XCMWEUkHUfrifO5mnt',
		'xDX7a7M9Oo9s7pnfKQUo',
		'ZJcF1uQglN5AIUM7Yrkc',
		'mBXV3MzVN0rqUe2aNQwv',
		'cpqeg5qFAnjaLAZa7u1y',
		'_pot_container_',
		'_floatInHome_',
		'_swipers_',
		'_poolsBg_',
		...
		'index_notice',
		'psmtc_',
		'I2_iYLYYG250ofYSsMLU',
		'HzLBVwTAr8vh_Ocr1Mne',
		'lEMmZjtXJGUAzu5aX_sj',
	...
	const attributesToRemove: string[] = [
		'[data-type="MobilePddTurntablePopup"]',
		'[data-type="WebPddTurntablePopup"]',
		'[data-type="NotiftPopup"]',
		'[data-v-c1995e97]',
		'[data-v-734b3821]',
		'[data-v-812c107f]',
		'[data-v-b1f9c970]',
		...
		'[data-v-ea95bab2]',
		'.notice.flex',
		'[data-type="MobileTopDownloadPopup"]',
		'.jackpot',
		'.support',
		'.game-banner.isHomePage',
		'.van-swipe.home-banner',
